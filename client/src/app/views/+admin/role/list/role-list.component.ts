...
@Component({
  ...
  template: `
    <div class="container">
      ...
      <div fxLayout="row" fxLayoutAlign="center center">
        <div class="item" fxFlex="98%">
          <button mat-raised-button color="primary" routerLink="/admin/role/create" routerLinkActive="active">
...
export class RoleListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  onDelete(role: Role): void {
    const dialogRef = this.dialog.open(ConfirmComponent, {
      data: {
        message: `¿Está seguro que desea eliminar el usuario "${role.name}"?`,
      }
    });
